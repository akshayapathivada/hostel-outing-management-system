...
ResultSet rs = stm.executeQuery("select * from outings where status='IN' and year='3' and approval='yes' and wapproval='review'");
while(rs.next()){
...
%>
      <tr>
        ...
        <td><a href="IIIYearStudents.jsp?redg1=<%= redg %>&wapproval=yes" style="text-decoration: none;"><button style="background-color: green;">Accept</button></a></td>
        <td><a href="IIIYearStudents.jsp?redg1=<%= redg %>&wapproval=no" style="text-decoration: none;"><button style="background-color: red;">Reject</button></a></td>
      </tr>
<%
}
con.close();
